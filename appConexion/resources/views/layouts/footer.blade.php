                    ...
                    <div class="col-md-5 col-lg-5 col-sm-12 col-xs-12">
                        <div class="single-footer footer-about sm-mb50 xs-mb50 sm-center xs-center">
                            <div class="footer-logo mb30">
                                ...
                                <a href="www.conexiongrafica.com" style="color: #fff;">Conexión Grafica</a>
                            </div>
                        ...
                        <div class="single-footer footer-subscribe white xs-center">
                            ...
                            <div class="subscriber-form-area mt50 wow fadeIn">
                                <form id="mc-form" class="subscriber-form">
                                    ...
                                    <input type="email" id="mc-email" placeholder="tucorreo@example.com">
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                        <div class="footer-copyright text-center wow fadeIn">
                            <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                Copyright &copy;<script>document.write(new Date().getFullYear());</script> Todos los derechos son reservados | <a href="https://conexiongrafica.com" target="_blank">www.conexióngrafica.com</a>
                        </div>
                    </div>
                </div>
            </div>
